...
using AuthenticationService = Identity.Application.Services.AuthenticationService;
using LoginRequest = Identity.Application.Services.LoginRequest;
using RegisterRequest = Identity.Application.Services.RegisterRequest;
